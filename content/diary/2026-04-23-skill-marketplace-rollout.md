...
최근에 팀에서 혼자 작은 도구 하나를 만들었다. *시작은 거창하지 않았다.* 주말에 책상 앞에 앉아 `rules`와 `skills`를 관리하는 MCP 하나를 만들어본 것이 전부였다. **누가 시킨 것도, 봐달라고 만든 것도 아니었다.** 그저 팀 안에서 여기저기 흩어진 채 난잡하게 관리되고 있는 rules와 skills를 보며, 이걸 한곳에 정돈해 두면 좋겠다는 생각 하나뿐이었다.

...
클라이언트 측 API다. ([https://ko.react.dev/reference/react-dom/client/hydrateRoot](https://ko.react.dev/reference/react-dom/client/hydrateRoot))
...
CSR에서 제공하는 createRoot([https://ko.react.dev/reference/react-dom/client/createRoot](https://ko.react.dev/reference/react-dom/client/createRoot))와는

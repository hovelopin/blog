...
### 가장 단순한 fix — hooks 단에서 `gcTime` 빼기
...
### 클라이언트 캐시는 길게 두고 싶다면 — `makeQueryClient`에서 분기
...
### 가장 정석 — `prefetchQuery` + `<HydrationBoundary>`
